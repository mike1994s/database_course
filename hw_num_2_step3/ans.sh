...
#sqlite3 m3_hw2.db "SELECT conference, COUNT(conference) FROM
...
sqlite3 m3_hw2.db "SELECT title FROM Paper WHERE conference NOT IN (SELECT value FROM Conference)"
